@extends('pos.pos-tpl')
@section('title') Edit {{ $addon->addon_name }} @endsection
	...
	<div class="row">
		<div class="col-12 col-md-12 col-lg-9">
			<div class="row justify-content-between">
				<div class="col-auto"><h4 class="mb-0">Edit: <small>{{ $addon->addon_name }}</small></h4></div>
					...
					<form action="{{ route('addon.update', $addon->id) }}" method="post">
						...
						<div class="card rounded-0 border-0 shadow p-3">
							<div class="card-header bg-white">
								<div class="row">
									<div class="col-12">
										<button type="submit" class="btn btn-md pos-bg-green text-white">Update Addon</button> | 
									...
									<div class="col-12 col-md-8 col-lg-7">
										<div class="row mb-3">
											<div class="col-12">
												...
												<input type="text" name="addon_name" class="form-control border-secondary" value="{{ $addon->addon_name }}">
