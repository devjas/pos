	...
	<div class="row">
		<div class="col-12 col-md-12 col-lg-9">
			<div class="row justify-content-between">
				<div class="col-auto"><h4 class="mb-0"><small>Edit:</small> {{ $item->item_name }}</h4></div>
							...
							<div class="card-header bg-white">
								<div class="row justify-content-between">
									<div class="col-auto align-self-end">
										<button type="submit" class="btn btn-md pos-bg-green text-white">Update Item</button> | 
									...
									<div class="col-12 col-md-10 col-lg-8 col-xl-7">
											...
											<div class="col-12">
												...
												<select name="item_category[]" multiple class="border-secondary" id="selectOption" data-multi="multi-select">
													@foreach($categories as $category)
														<option value="{{ $category->id }}" {{ $item->categories->contains($category->id) ? "selected" : "" }}>{{ $category->pos_category }}</option>
													@endforeach
												</select>
										...
										<div class="row mb-2">
											<div class="col-12">
												...
												<input type="text" name="item_name" class="form-control border-secondary" value="{{ $item->item_name }}">
										...
										<div class="row mb-2">
											<div class="col-12">
												...
												<textarea type="text" name="item_description" class="form-control border-secondary">{{ $item->item_description }}</textarea>
										...
										<div class="row mb-3">
											<div class="col-12 col-sm-5 mb-2 mb-lg-0">
												...
												<input type="text" name="item_price" class="form-control border-secondary" value="{{ $item->item_price }}">
											...
											<div class="col-12 col-sm-3 mb-2 mb-lg-0">
												...
												<select name="item_per" class="form-select border-secondary">
													...
													<option value="1" {{ $item->item_per == 1  ? "selected" : null }}>Each</option>
													<option value="2" {{ $item->item_per == 2 ? "selected" : null }}>LB</option>
													<option value="3" {{ $item->item_per == 3 ? "selected" : null }}>Dozen</option>
													<option value="4" {{ $item->item_per == 4 ? "selected" : null }}>Half Dozen</option>
												</select>
											...
											<div class="col-12 col-sm-4">
												...
												<select name="item_tax" class="form-select border-secondary">
													...
													<option value="0.0625" {{ $item->item_tax == 0.0625 ? "selected" : "" }}>CT Tax</option>
													<option value="0.0789" {{ $item->item_tax == 0.0789 ? "selected" : "" }}>NY Tax</option>
												</select>
										...
										<div class="row mb-3">
											...
											<div class="col-12">
												<div class="check-btn">
													<label>
														<input type="checkbox" name="special_item" value="1" {{ $item->is_special_item == 1 ? "checked" : "" }}>
										...
										<div class="row">
											...
											<div class="col-12">
												<div class="check-btn">
													<label>
														<input type="radio" name="is_visible" value="1" {{ $item->is_visible == 1 ? "checked" : "" }}>
														<span class="check-btn-span"><span>Visible</span></span>
													</label>
													<label>
														<input type="radio" name="is_visible" value="2" {{ $item->is_visible == 2 ? "checked" : "" }}>
