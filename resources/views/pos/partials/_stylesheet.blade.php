<link rel="stylesheet" type="text/css" href="{{ asset('/pos/fonts/website-font.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('/pos/css/bootstrap/bootstrap-reboot.min.css') }}">
